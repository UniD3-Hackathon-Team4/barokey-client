import * as S from "./LocalCongestionButton.style";
import React, { useEffect, useState } from "react";
// import {Button} from 'react-bootstrap'
// import 'bootstrap/dist/css/bootstrap.min.css';
import axios from "axios";
// import { LocalCongestionButton } from "..";
// import './App.css';

const { kakao } = window;

const LocalCongestionButton = () => {
	...
	return (
		// <div className="App">
		<S.Container onClick={Menu1}> 지역 혼잡도 </S.Container>
		// </div>
	);
};

export default LocalCongestionButton;
